							...
							?>
								<tr>
									...
									<td class="text-center">
										<a class="btn btn-sm btn-primary" href="index.php?page=manage_receiving&id=<?php echo $row['id'] ?>"><i class="fa fa-edit"></i></a>
										<a class="btn btn-sm btn-danger delete_receiving" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><i class="fa fa-trash"></i></a>
									</td>
								</tr>
							<?php endwhile; ?>
							</tbody>
