	...
	<table width="100%">
				...
				<tr>
					<td>
						<table width="100%">
							<tr>
								<td width="5px" class="text-right">Customer :</td>
								<td width="4x" class="bbottom"><?php echo ucwords($cname) ?></td>
				...
				<tr>
					<th>
						<p class="text-left"><i>This is not an official receipt.</i></p>
