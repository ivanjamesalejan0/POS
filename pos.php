					      ...
					      <div class="modal-body">
					      	<div class="container-fluid">
					      		...
					      		<div class="form-group">
					      			...
					      			<input type="number" name="amount_tendered" value="" min="" class="form-control text-right" >
					      		</div>
					      		<div class="form-group">
					      			<label for="" class="control-label">Change</label>
					      			<input type="number" name="change" value="" min="" class="form-control text-right" readonly="">
					      		</div>
					      	</div>
					      </div>
